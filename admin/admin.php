...
add_action( 'admin_enqueue_scripts', array( 'WLSM_Menu', 'admin_enqueue_asstes' ) );
...
add_action( 'wp_ajax_new_testimonials_eng', array( 'WLSM_Staff_General', 'new_testimonials_eng' ) );
add_action( 'wp_ajax_print_testimonials_cards', array( 'WLSM_Staff_General', 'print_testimonials_cards' ) );
add_action( 'wp_ajax_fetch_student_data_testimonials_cards', array( 'WLSM_Staff_General', 'fetch_student_data_testimonials_cards' ) );
...
add_action( 'wp_ajax_get_exam_based_on_class', array( 'WLSM_Staff_Examination', 'fetch_exams_class_based' ) );
add_action( 'wp_ajax_get_class_based_section', array( 'WLSM_Staff_Examination', 'get_class_based_section' ) );
add_action( 'wp_ajax_get_exam_papers_on_exam', array( 'WLSM_Staff_Examination', 'fetch_exam_papers_on_exam' ) );
add_action( 'wp_ajax_get_student_record_id', array( 'WLSM_Staff_Examination', 'get_student_record_id' ) );
add_action( 'wp_ajax_wlsm_add_bulk_result', array( 'WLSM_Staff_Examination', 'wlsm_add_bulk_result' ) );
add_action( 'wp_ajax_get_class_based_exam', array( 'WLSM_Staff_Examination', 'get_class_based_exam' ) );
...
add_action( 'wp_ajax_wlsm_get_exam_results_excel', array( 'WLSM_Staff_Examination', 'bulk_print_result_excel' ) );
add_action( 'wp_ajax_wlsm_download_exam_results_excel', array( 'WLSM_Staff_Examination', 'download_exam_results_excel' ) );
add_action( 'wp_ajax_wlsm_get_student_religion_status', array( 'WLSM_Staff_Examination', 'wlsm_get_student_religion_status' ) );
...
add_action( 'wp_ajax_get_all_section_student', array( 'WLSM_Staff_General', 'get_all_section_student' ) );
...
add_action( 'wp_ajax_wlsm-get-class-optional-subjects', array( 'WLSM_Staff_General', 'get_class_optional_subjects' ) );
