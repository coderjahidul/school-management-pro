		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-save-staff-form">
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_mpo_date" class="wlsm-font-bold">
							<?php esc_html_e( 'M.P.O Date', 'school-management' ); ?>:
						</label>
						<input type="text" name="mpo_date" class="form-control" id="wlsm_mpo_date" placeholder="<?php esc_attr_e( 'Enter M.P.O Date', 'school-management' ); ?>" value="<?php echo esc_attr( WLSM_Config::get_date_text( $mpo_date ) ); ?>">
					</div>
					<div class="form-group col-md-4">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_note" class="wlsm-font-bold">
							<?php esc_html_e( 'Index Number/ Description', 'school-management' ); ?>:
						</label>
