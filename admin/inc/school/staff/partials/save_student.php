...
if ( isset( $_GET['id'] ) && ! empty( $_GET['id'] ) ) {
	...
	if ( $student ) {
		...
		$optional_subject_code = $student->optional_subject_code;
		...
		if ($class_school) {
			...
			$subject_list = WLSM_M_Staff_Class::subject_list("objective", $class_school_id);
		}
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					<?php if ( $school_registration_religion ) : ?>
						...
						<select name="religion" id="wlsm_religion" class="form-control selectpicker">
							<option value=""><?php esc_attr_e( 'Select religion', 'school-management' ); ?></option>
							<option <?php if(esc_attr( stripcslashes( $religion ) ) == 'islam' ){ echo 'selected'; }; ?> value="islam">Islam</option>
							<option <?php if(esc_attr( stripcslashes( $religion ) ) == 'hindu' ){ echo 'selected'; }; ?> value="hindu">Hindu</option>
							<option   <?php if(esc_attr( stripcslashes( $religion ) ) == 'christian' ){ echo 'selected'; }; ?>  value="christian">Christian</option>
							<option  <?php if(esc_attr( stripcslashes( $religion ) ) == 'buddhist' ){ echo 'selected'; }; ?>   value="buddhist">Buddhist</option>
						</select>
					</div>
					<?php endif ?>
			...
			<div class="wlsm-form-section">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_class" class="wlsm-font-bold">
							...
							<select name="class_id" class="form-control selectpicker wlsm_class_optional_subjects" data-nonce="<?php echo esc_attr( wp_create_nonce( 'get-class-sections' ) ); ?>" data-nonce-subjects="<?php echo esc_attr( wp_create_nonce( 'get-class-optional-subjects' ) ); ?>" id="wlsm_class" data-live-search="true">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<select name="note" id="wlsm_note" class="form-control selectpicker">
							...
							foreach ($options as $value => $label) {
								$selected = ($value == $note) ? 'selected' : '';
								echo "<option value='$value' $selected>$label</option>";
								// print_r( "<option value='$value' $selected> $label</option>");
							}
							// echo( $selected);
						...
						<!-- <input type="text" name="note" class="form-control" id="wlsm_note" placeholder="<?php esc_attr_e( 'Science/Arts/Commerce', 'school-management' ); ?>" value="<?php echo esc_html( stripcslashes( $note ) ); ?>"></input> -->
					</div>
					...
					<div class="form-group col-md-4">
						<label for="wlsm_optional_subject_code" class="wlsm-font-bold">
							 <?php esc_html_e( 'Optional Subject', 'school-management' ); ?>:
						</label>
						<select name="optional_subject_code"
						class="form-control selectpicker"
						id="wlsm_optional_subject"
						data-live-search="true"
						title="<?php esc_attr_e( 'Select Subject', 'school-management' ); ?>">

							<?php
							foreach ( $subject_list as $subject ) { ?>
								<option value="<?php echo esc_attr( $subject->code ); ?>" <?php selected( $subject->code, $optional_subject_code, true ); ?>>
