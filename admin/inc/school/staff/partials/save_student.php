...
if ( isset( $_GET['id'] ) && ! empty( $_GET['id'] ) ) {
	...
	if ( $student ) {
		...
		$subject_list	= WLSM_M_Staff_Class::subject_list( $type = "objective", $class_school_id = 2);
				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						<label for="wlsm_optional_subject_code" class="wlsm-font-bold">
							<span class="wlsm-important">*</span> <?php esc_html_e( 'Optional Subject', 'school-management' ); ?>:
						</label>
						<select name="optional_subject_code" class="form-control selectpicker" id="wlsm_optional_subject_code" data-live-search="true" title="<?php esc_attr_e( 'Select Subject', 'school-management' ); ?>">
							<?php
