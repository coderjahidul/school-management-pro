...
if ($admit_card) {
	...
	$exam_papers_common  = WLSM_M_Staff_Examination::get_exam_papers_by_admit_card($school_id, $admit_card_id);
	$exam_papers_religion  = WLSM_M_Staff_Examination::get_religion_exam_papers_by_admit_card($school_id, $admit_card_id);
	$exam_papers = array_merge($exam_papers_common , $exam_papers_religion);
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select name="student_admit_card_id" class="form-control selectpicker wlsm_students_subjects" id="wlsm_students" data-nonce="<?php echo esc_attr(wp_create_nonce('get-students-subjects')); ?>" data-nonce-subjects="<?php echo esc_attr(wp_create_nonce('get-students-subjects')); ?>"  data-live-search="true" data-none-selected-text="<?php esc_attr_e('Select Student', 'school-management'); ?>">
									...
									?>
										<option value="<?php echo esc_attr($record->ID); ?>" data-student-id="<?php  echo esc_attr($record->student_id);  ?>">
											<?php
											printf(
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<input type="number" id="<?php echo 'obtained_mark_'.$exam_paper->religion; ?>" step="any" min="0" name="obtained_marks[<?php echo esc_attr($exam_paper->ID); ?>]" class="form-control obtained_mark_input" value="<?php echo esc_attr($obtained_marks); ?>">
											</td>
											<td>
