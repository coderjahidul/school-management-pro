...
$has_submenu_types = WLSM_Helper::has_parent_type_list();
$get_subject_group = WLSM_Helper::get_subject_group();
?>
<div class="row">
	<div class="col-md-12">
				...
				<div class="wlsm-exam-papers-box" data-subject-name="<?php esc_attr_e( 'Subject Name', 'school-management' ); ?>" data-subject-name-placeholder="<?php esc_attr_e( 'Enter subject name', 'school-management' ); ?>" data-room-number="<?php esc_attr_e( 'Room Number', 'school-management' ); ?>" data-room-number-placeholder="<?php esc_attr_e( 'Enter room number', 'school-management' ); ?>" data-subject-type="<?php esc_attr_e( 'Subject Type', 'school-management' ); ?>" data-maximum-marks="<?php esc_attr_e( 'Maximum Marks', 'school-management' ); ?>" data-maximum-marks-placeholder="<?php esc_attr_e( 'Enter maximum marks', 'school-management' ); ?>" data-paper-code="<?php esc_attr_e( 'Paper Code / Subject Code', 'school-management' ); ?>" data-paper-code-placeholder="<?php esc_attr_e( 'Exam paper code', 'school-management' ); ?>" data-paper-date="<?php esc_attr_e( 'Paper Date', 'school-management' ); ?>" data-paper-date-placeholder="<?php esc_attr_e( 'Exam paper date', 'school-management' ); ?>" data-start-time="<?php esc_attr_e( 'Start Time', 'school-management' ); ?>" data-start-time-placeholder="<?php esc_attr_e( 'Exam paper start time', 'school-management' ); ?>" data-end-time="<?php esc_attr_e( 'End Time', 'school-management' ); ?>" data-end-time-placeholder="<?php esc_attr_e( 'Exam paper end time', 'school-management' ); ?>" data-subject-types="<?php echo esc_attr( json_encode( $subject_types ) ); ?>" data-religion-types="<?php echo esc_attr( json_encode( $religion_types ) ); ?>" data-submenu-types="<?php echo esc_attr( json_encode( $has_submenu_types ) ); ?>" data-subject-group="<?php echo esc_attr( json_encode( $get_subject_group ) ); ?>">
					...
					<div class="wlsm-exam-paper-box card col" data-exam-paper="<?php echo esc_attr( $index ); ?>">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-6 col-md-3">
								<label for="wlsm_sub_religion<?php echo esc_attr( $index ); ?>" class="wlsm-font-bold">
									<?php esc_html_e( 'Subject Religion', 'school-management' ); ?>:
								</label>
								<!-- <input type="text" name="sub_religion[]" class="form-control" id="wlsm_room_number_<?php echo esc_attr( $index ); ?>" placeholder="<?php esc_attr_e( 'Exam room number', 'school-management' ); ?>" value="<?php echo esc_attr( $exam_paper->room_number ); ?>"> -->
								<select name="sub_religion[]" id="wlsm_sub_religion" class="form-control selectpicker">
									<option value="common" <?php if(esc_attr( $exam_paper->religion ) =='common'){ echo 'selected';}; ?>>Common</option>
									<option value="islam" <?php if(esc_attr( $exam_paper->religion ) =='islam'){ echo 'selected';}; ?>>Islam</option>
									<option value="hindu" <?php if(esc_attr( $exam_paper->religion ) =='hindu'){ echo 'selected';}; ?>>Hindu</option>
									<option value="christian" <?php if(esc_attr( $exam_paper->religion ) =='christian'){ echo 'selected';}; ?>>Christian</option> 
									<option value="buddhist" <?php if(esc_attr( $exam_paper->religion ) =='buddhist'){ echo 'selected';}; ?>>Buddhist</option> 
								</select>
							</div>
							<div class="form-group col-sm-6 col-md-3">
								<label for="wlsm_sub_religion<?php echo esc_attr( $index ); ?>" class="wlsm-font-bold">
									<?php esc_html_e( 'Subject Group', 'school-management' ); ?>:
								</label>
								<!-- <input type="text" name="sub_religion[]" class="form-control" id="wlsm_room_number_<?php echo esc_attr( $index ); ?>" placeholder="<?php esc_attr_e( 'Exam room number', 'school-management' ); ?>" value="<?php echo esc_attr( $exam_paper->room_number ); ?>"> -->
								<select name="sub_group[]" id="wlsm_sub_group" class="form-control selectpicker">
									<option value="common" <?php if(esc_attr( $exam_paper->religion ) =='common'){ echo 'selected';}; ?>>Common</option>
									<option value="science" <?php if(esc_attr( $exam_paper->religion ) =='islam'){ echo 'selected';}; ?>>Science</option>
									<option value="commerce" <?php if(esc_attr( $exam_paper->religion ) =='hindu'){ echo 'selected';}; ?>>Commerce</option>
									<option value="christian" <?php if(esc_attr( $exam_paper->religion ) =='christian'){ echo 'selected';}; ?>>Christian</option> 
									<option value="humanity" <?php if(esc_attr( $exam_paper->religion ) =='buddhist'){ echo 'selected';}; ?>>Humanity</option> 
									<option value="vocational" <?php if(esc_attr( $exam_paper->religion ) =='buddhist'){ echo 'selected';}; ?>>Vocational</option> 
									<option value="optional" <?php if(esc_attr( $exam_paper->religion ) =='buddhist'){ echo 'selected';}; ?>>Optional</option> 
								</select>
							</div>

							<!-- <div class="form-group col-sm-6 col-md-3">
								<label for="wlsm_sub_has_parent" class="wlsm-font-bold">
									<?php esc_html_e( 'Subject has Parent', 'school-management' ); ?>:
								</label>
								<select name="sub_has_parent[]" id="wlsm_sub_has_parent" class="form-control selectpicker">
									<option value="parent" <?php  if($exam_paper->subject_label == $exam_paper->parent_subject){echo "selected";} ?> >Parent</option>
									<option <?php  if($exam_paper->subject_label != $exam_paper->parent_subject){echo "selected";} ?>  value="sub_subject">Has Sub Subject</option>
								</select>
							</div> -->

                            <?php
							 if($exam_paper->subject_label != $exam_paper->parent_subject){

								?>
							<div class="form-group col-sm-6 col-md-3" id="sub_subject_box" >
								<label for="wlsm_subject_parent_name" class="wlsm-font-bold">Enter Parent Subject Name</label>
								<input type="text" name="subject_parent_name[]" class="form-control" id="wlsm_subject_parent_name" placeholder="Enter Parent Subject Name" value="<?php echo esc_attr( $exam_paper->parent_subject ); ?>"> 
							</div>
					...
					<div class="wlsm-exam-paper-box card col" data-exam-paper="1">
						...
						<div class="form-row" id="exam_paper_add_details_box">
							<div class="form-group col-sm-6 col-md-4">
							...
							<div class="form-group col-sm-6 col-md-3">
								<label for="wlsm_sub_religion" class="wlsm-font-bold">
									<?php esc_html_e( 'Subject Religion', 'school-management' ); ?>:
								</label>
								<!-- <input type="text" name="sub_religion[]" class="form-control" id="wlsm_sub_religion" placeholder="<?php esc_attr_e( 'Exam room number', 'school-management' ); ?>" value=""> -->
								<select name="sub_religion[]" id="wlsm_sub_religion" class="form-control selectpicker">
