			...
			<table class="table table-hover table-bordered" id="wlsm-lecture-table">
				<thead>
					<tr class="text-white bg-primary">
						...
						<th scope="col"><?php esc_html_e( 'Single Qualification', 'school-management' ); ?></th>
