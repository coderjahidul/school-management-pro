...
$class_roll_number = '';
if ( isset( $admit_card->student_class_roll_number ) ) {
	$class_roll_number = $admit_card->student_class_roll_number;
} elseif ( isset( $admit_card->student_roll ) ) {
	$class_roll_number = $admit_card->student_roll;
}
