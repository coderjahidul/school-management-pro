...
<div class="wlsm-print-exam-results-container" style="border-image-source:url('<?php echo WLSM_PLUGIN_URL . "assets/images/result-border.png"; ?>');">
		...
		<div class="row wlsm-student-details">
			...
			<div class="col-md-6" style="width: 30%">
				...
				<table class="marks-distribution" border="1" style="font-size: 12px !important;  text-align: left !important;">
					<tr align="center">
						<th style="padding: 5px !important;"><span><?php esc_html_e( 'Class Interval', 'school-management' ); ?></span></th>
						<th style="padding: 5px !important;"><span><?php esc_html_e( 'Letter Grade', 'school-management' ); ?></span></th>
						<th style="padding: 5px !important;"><span><?php esc_html_e( 'Grade Point', 'school-management' ); ?></span></th>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '80-100', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'A+', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '5', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '70-79', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'A', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '4', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '60-69', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'A-', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '3.5', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '50-59', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'B', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '3', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '40-49', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'C', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '2', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '33-39', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'D', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '1', 'school-management' ); ?></span></td>
					</tr>
					<tr align="center">
						<td style="padding: 3px !important;"><span><?php esc_html_e( '0-32', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( 'F', 'school-management' ); ?></span></td>
						<td style="padding: 3px !important;"><span><?php esc_html_e( '0', 'school-management' ); ?></span></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered wlsm-view-exam-results-table">
					...
					<thead>
						<tr>
							<th><?php esc_html_e( 'Code', 'school-management' ); ?></th>
					...
					<tbody>
						...
						$student_rank = WLSM_M_Staff_Examination::calculate_exam_ranks($school_id, $exam_id, array(), $result->admit_card_id , $result->note);
						...
						?>
						<tr>
							<th colspan="8"><?php esc_html_e( '4th Subject (Above 2)', "school-management" );?></th>
						</tr>
						<tr>
							<td><?php $optional_papre_code = esc_html($subject[0]->paper_code);
									echo $optional_papre_code;
							?></td>
							<td><?php echo esc_html($subject[0]->subject_label);?></td>
							<td>
								<?php
						...
						<tr>
							...
							<th colspan="3"><?php echo esc_html( $optional_and_mainsubject_totol_mark ); ?></th>
							<?php if ( $show_marks_grades ) { ?>
						...
						<tr>
							...
							<td></td>
							<th colspan = "3"><?php esc_html_e( 'GPA Without Ad. Sub', 'school-management' );?></th>
							<?php if ( $show_marks_grades ) { ?>
							<td>
								<?php
						...
						<tr>
							<th colspan="3"><?php //esc_html_e( 'Percentage', 'school-management' ); ?></th>
							<th colspan="3"><?php 
						...
						<?php if ($show_rank === '1'){ ?>
						<tr>
							<th colspan="2"><?php esc_html_e( 'Rank', 'school-management' ); ?></th>
							<?php 
						...
						<tr>
							<td colspan="2"><strong><?php esc_html_e( 'Hadteacher :', 'school-management' ); ?></strong>  <?php  echo $teacher_remark; ?></td>
							<td colspan ="2"></td>							

							<td colspan="2"><strong><?php esc_html_e( 'Principal :', 'school-management' ); ?></strong>  <?php  echo $school_remark; ?></td>
							<td colspan="2"></td>		
