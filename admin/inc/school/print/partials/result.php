...
<div class="wlsm-container wlsm" id="wlsm-print-exam-results">
	<!-- Keep style inside print target so iframe print preserves design. -->
	<style type="text/css">
		...
		.wlsm-print-exam-results-container .table thead th {
			vertical-align: bottom;
			border-bottom: 2px solid #000000 !important;
		}
		.wlsm-print-exam-results-container .table-bordered,
		.wlsm-print-exam-results-container .table-bordered td,
		.wlsm-print-exam-results-container .table-bordered th {
			...
			<div class="col-md-6" style="width: 70%">
				<ul class="wlsm-list-group">
					...
					<li>
						...
						<span class="wlsm-font-bold">
						<?php echo esc_html(WLSM_M_Staff_Class::get_roll_no_text(isset($result->student_class_roll_number) ? $result->student_class_roll_number : '')); ?>
						</span>
					</span>
					<!-- <span class="wlsm-pr-3 pr-3">
