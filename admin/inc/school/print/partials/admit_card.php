...
<div class="wlsm-container wlsm wlsm-form-section" id="">
	<div class="wlsm-print-exam-admit-card-container" style="border-image-source: url('<?php  echo WLSM_PLUGIN_URL . "assets/images/out.png" ?>');">
		...
		<div class="row wlsm-student-details">
			<div class="col-9 wlsm-student-details-right">
				<ul class="wlsm-list-group">
					...
					<!-- <li>
						<span class="wlsm-font-bold"><?php //esc_html_e('E.R Number', 'school-management'); ?>:</span>
						<span><?php //echo esc_html($enrollment_number); ?></span>
					</li> -->
					<li>
						<span class="wlsm-font-bold"><?php esc_html_e('Admit Identify', 'school-management'); ?>:</span>
					...
					<li>
						...
						<span class="wlsm-pr-3 pr-3">
							<span class="wlsm-font-bold"><?php esc_html_e('Group', 'school-management'); ?>:</span>
							<span><?php echo esc_html(WLSM_M_Session::get_label_text($group_label)); ?></span>
						</span>
					</li>
					<li>
						<span class="wlsm-pr-3 pr-3">
					...
					<li>
						<span class="wlsm-font-bold"><?php esc_html_e('Class Roll', 'school-management'); ?>:</span>
						<span><?php echo esc_html(WLSM_M_Staff_Class::get_roll_no_text($class_roll_number)); ?></span>
					</li>
		...
		<div class="row wlsm-admit-card-footer">
			<div class="col-12">
				<span class="wlsm-font-bold"><?php esc_html_e('Class Teacher signature:', 'school-management'); ?></span>
			</div>
			<div class="col-12 wlsm-admit-card-exam">
				<span>
					<?php
					printf(
						wp_kses(
