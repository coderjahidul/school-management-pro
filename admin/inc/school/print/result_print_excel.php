...
<div class="table-container excel_result_box" style="width:100%;overflow-x: auto;"  id="wlsm-print-result-excel">
	<table>
		<thead>
			<tr><h4 style="text-align: center;margin:10px 0px">Class : <?php echo $class_id; ?> & Section : <?php 
        ...
        <tbody>
			<tr>
				...
				<th rowspan="2"><?php esc_html_e("Total Mark", "school-management")?></th>
				<th rowspan="2"><?php esc_html_e("LG Without Ad. Sub", "school-management")?></th>
				<th rowspan="2"><?php esc_html_e("CGPA Without Ad. Sub", "school-management")?></th>
								...
								if($paper_code == 101){?>
									...
									<td>
										<?php 
											...
											$minimam_cq_fash_marks = $bangla_total_cq_maxmarks / 3;
											$minimam_mcq_fash_marks = $bangla_total_mcq_maxmarks / 3;
									...
									<td>
										<?php 
											...
											$divide_english_mark = $english_total_marks / 2;
										...
										<td>
											<?php 
												...
												if($group_subject_cq_marks >= 1 || $group_subject_mcq_marks >= 1 || $group_subject_practical_marks >= 1){
													...
													$minimam_group_subject_cq_fash_mark = $group_subject_cq_maxmarks / 3;
													$minimam_group_subject_mcq_fash_mark = $group_subject_mcq_maxmarks / 3;
													$minimam_group_subject_practical_fash_mark = $group_subject_practical_maxmarks / 3;
										...
										<td>
											<?php 
												...
												if($objective_cq_marks >= 1 || $objective_mcq_marks >= 1 || $objective_practical_marks >= 1){
													...
													$minimam_objective_cq_fash_mark = $objective_cq_maxmarks / 3;
													$minimam_objective_mcq_fash_mark = $objective_mcq_maxmarks / 3;
													$minimam_objective_practical_fash_mark = $objective_practical_maxmarks / 3;
									...
									<td>
										<?php 
											...
											if($other_subject_cq_marks >= 1 || $other_subject_mcq_marks >= 1){
												...
												$minimam_other_subject_cq_fash_mark = $other_subject_cq_maxmarks / 3;
												$minimam_other_subject_mcq_fash_mark = $other_subject_mcq_maxmarks / 3;
