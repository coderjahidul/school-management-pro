...
class WLSM_School {
	...
	public static function save() {
		...
		try {
			...
			$school_name_bangla       = isset( $_POST['school_name_bangla'] ) ? sanitize_text_field( $_POST['school_name_bangla'] ) : '';
			$established_date       = isset( $_POST['established_date'] ) ? sanitize_text_field( $_POST['established_date'] ) : '';
			$established_date_bangla       = isset( $_POST['established_date_bangla'] ) ? sanitize_text_field( $_POST['established_date_bangla'] ) : '';
			$address_bangla       = isset( $_POST['address_bangla'] ) ? sanitize_text_field( $_POST['address_bangla'] ) : '';
		...
		if ( count( $errors ) < 1 ) {
			try {
				...
				$data = array(
					...
					'established_date_bangla'         => $established_date_bangla,
