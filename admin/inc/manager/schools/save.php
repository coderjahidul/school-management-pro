...
if ( isset( $_GET['id'] ) && ! empty( $_GET['id'] ) ) {
	...
	if ( $school ) {
		...
		$label       = $school->label;
		$school_name_bangla       = $school->school_name_bangla;
		$phone       = $school->phone;
		$email       = $school->email;
		$address     = $school->address;
		$description = $school->description;
		$established_date_bangla = $school->established_date_bangla;
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="wlsm_school_name_bangla" class="font-weight-bold"><span class="wlsm-important">*</span> <?php esc_html_e( 'School Name Bangla', 'school-management' ); ?>:</label>
								<input type="text" name="school_name_bangla" class="form-control" id="wlsm_school_bangla" placeholder="<?php esc_attr_e( 'Enter school name Bangla', 'school-management' ); ?>" value="<?php echo esc_attr( WLSM_M_School::get_label_text( $school_name_bangla ) ); ?>">
							</div>
							...
							<div class="form-group">
								<label for="wlsm_established" class="font-weight-bold"><?php esc_html_e( 'Established Date', 'school-management' ); ?>:</label>
								<input type="text" name="established_date" class="form-control" id="wlsm_established_date" placeholder="<?php esc_attr_e( 'Enter Established Date', 'school-management' ); ?>" value="<?php echo esc_attr( $established_date ); ?>">
							</div>
							<div class="form-group">
								<label for="wlsm_established_bangla" class="font-weight-bold"><?php esc_html_e( 'Established Date Bangla', 'school-management' ); ?>:</label>
								<input type="text" name="established_date_bangla" class="form-control" id="wlsm_established_date_bangla" placeholder="<?php esc_attr_e( 'Enter Established Date Bangla', 'school-management' ); ?>" value="<?php echo esc_attr( $established_date_bangla ); ?>">
							</div>
							...
							<div class="form-group">
								<label for="wlsm_address_bangla" class="font-weight-bold"><?php esc_html_e( 'Address Bangla', 'school-management' ); ?>:</label>
								<textarea name="address_bangla" class="form-control" id="wlsm_address_bangla" rows="3" placeholder="<?php esc_attr_e( 'Enter school address Bangla', 'school-management' ); ?>"><?php echo esc_html( $address_bangla ); ?></textarea>
							</div>
