...
class WLSM_M_Role {
	...
	public static function get_permissions() {
		return array(
			...
			'manage_testimonials'         => esc_html__( 'Manage Testimonials', 'school-management' ),
			'manage_new_testimonials'     => esc_html__( 'Manage New Testimonials', 'school-management' ),
			...
			'manage_gsms'               => esc_html__( 'Manage GSMS', 'school-management' ),
