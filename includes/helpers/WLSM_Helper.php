...
class WLSM_Helper {
	...
	public static function subject_type_list() {
		return array(
			...
			'subjective' => esc_html__( 'Main Subject', 'school-management' ),
			'mcq' => esc_html__( 'MCQ', 'school-management' ),
			'objective'  => esc_html__( 'Optional', 'school-management' ),
		);
	}
	public static function religion_type_list() {
		return array(
			'common'     => esc_html__( 'Common', 'school-management' ),
			'islam'  => esc_html__( 'Islam', 'school-management' ),
			'hindu' => esc_html__( 'Hindu', 'school-management' ),
			'christian'  => esc_html__( 'Christian', 'school-management' ),
			'buddhist'  => esc_html__( 'Buddhist', 'school-management' ),
		);
	}

	public static function has_parent_type_list() {
		return array(
			'parent'       => esc_html__( 'parent', 'school-management' ),
			'sub_subject'  => esc_html__( 'Has Sub Subject', 'school-management' ),
		);
	}


	public static function get_subject_group() {
		return array(
			'common'       => esc_html__( 'Common', 'school-management' ),
			...
			'optional'  => esc_html__( 'Optional', 'school-management' ),
		);
	}
