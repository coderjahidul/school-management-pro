...
define( 'WLSM_MENU_STAFF_TESTIMONIALS', 'sm-staff-testimonials' );
define( 'WLSM_MENU_STAFF_NEW_TESTIMONIALS', 'sm-staff-new-testimonials' );
...
define( 'WLSM_MENU_STAFF_EXAM_RESULTS_ADD_RESULT', 'sm-staff-exam-results-add-result' );
define( 'WLSM_MENU_STAFF_EXAM_RESULTS_EXCEL_PRINT', 'sm-staff-exam-results-excel-print' );
...
define('WLSM_MENU_STAFF_STUDENT_REPORT_CARD', 'sm-staff-student-report-card');
